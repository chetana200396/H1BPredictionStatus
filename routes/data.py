...
EMPL_START_DATE = array[1];
EMPL_END_DATE = array[2];
...
newdata = {'sum': EMPLOYER_NAME+EMPL_START_DATE+EMPL_END_DATE+EMPLOYER_STATE+AGENT_REPRESENTING_EMPLOYER+SOC_CODE+NAICS_CODE+FULL_TIME_POSITION+H1B_DEPENDENT+WORKSITE_STATE}
print(json.dumps(newdata))